...
declare function show_9904757(): Promise<void>;
...
export const SkywardSoarGame = () => {
 ...
 const restartGame = useCallback(() => {
  ...
  const handleRewardedAd = (e: React.MouseEvent) => {
    ...
    if (typeof show_9904757 !== 'function') {
      toast({
        title: 'خطأ',
        description: 'فشل تحميل وحدة الإعلانات. حاول مرة أخرى.',
        variant: 'destructive',
      });
      return;
    }
    ...
    show_9904757().then(() => {
      ...
      // Ad failed to show or was closed early
      console.error("Ad error:", error);
      toast({
        title: 'لم تكتمل المشاهدة',
        description: 'لم يتم منح المكافأة لأن الإعلان لم يكتمل.',
        variant: 'destructive'
      });
    }).finally(() => {
      // Start cooldown timer regardless of outcome
